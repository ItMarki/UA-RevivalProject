...
milestoneRequirements=['購買你第一個第一級生產器','購買你第一個第二級生產器','購買你第一個第三級生產器','購買你第一個第四級生產器','購買你第一個第五級生產器','購買你第一個第六級生產器','購買你第一個第七級生產器','購買你第一個第八級生產器','購買你第一個第九級生產器','購買你第一個第十級生產器',
	'購買5個第十級生產器',' 第一次聲望','到達5倍聲望力量','到達10倍聲望力量','到達20倍聲望力量','到達50倍聲望力量','到達75倍聲望力量','第一次轉移','購買2轉移升級','購買4轉移升級',
...
explainList={stars:'<b>恆星</b><br>恆星是遊戲中的主要貨幣和貨幣部分。你可以以這個花費於生產器！',gens:'<b>生產器</b><br>生產器是遊戲中的生產部分。遊戲中有10級，一級會生產上一級，但第一級會生產恆星。<br>當你購買一個，那個生產器會有一個5%的加成。',prestige:'<b>聲望</b><br>聲望是一個<i>軟</i>重置，但你會保留一些特徵和內容。<br>在這個遊戲，如果你立即聲望，你會將生產器上有一個倍數加成。',transfer:'<b>轉移</b><br>轉移像聲望，但是會重置你全部的聲望，給予玩家升級，而不是生產力倍數。轉移的貨幣叫做轉移點數，使用它花費升級。',
	tupg1:'<b>轉移升級<span style="font-size:66.6%">3</span></b><br>這個升級，數量每十的冪會將生產力倍數增加2%。',tupg2:'<b>轉移升級<span style="font-size:66.6%">1</span></b><br>這個升級，隨着遊戲開始的時間，會增加全部生產器的生產力倍數。',tupg3:'<b>轉移升級<span style="font-size:66.6%">2</span></b><br>這個升級，隨着轉移的次數，會增加全部生產器的生產力倍數。',tupg4:'<b>轉移升級<span style="font-size:66.6%">4</span></b><br>這個升級，隨着更高的聲望力量高峯，會增加全部生產器的生產力倍數。',tupg5:'<b>轉移升級<span style="font-size:66.6%">5</span></b><br>這個升級，隨着更高的轉移點數高峯，會增加全部生產器的生產力倍數。',tupg6:'<b>轉移升級<span style="font-size:66.6%">6</span></b><br>這個升級，隨着聲望力量獲得數，增加自己。',tupg7:'',
	tupg8:'<b>轉移升級<span style="font-size:66.6%">8</span></b><br>這個升級會減少第十級生產器的價格提升。',tupg9:'<b>轉移升級<span style="font-size:66.6%">9</span></b><br>這個<i>簡單的</i>升級將聲望力量獲得數翻倍。',tupg10:'<b>轉移升級<span style="font-size:66.6%">10</span></b><br>這個升級影響第十級生產器，令每買一個增加7%。',tupg11:'<b>轉移升級<span style="font-size:66.6%">11</span></b><br>這個升級，每購買一個第五集生產器，會將全部生產器的生產力倍數增加0.145%。',tupg12:'<b>轉移升級<span style="font-size:66.6%">12</span></b><br>這個升級將全部生產器的生產力倍數增加到3倍！',tupg13:'<b>轉移升級<span style="font-size:66.6%">13</span></b><br>你在購買首12升級，才可以解鎖這個。這個升級，隨着獲得更多轉移點數，增加聲望力量獲得數。',tupg14:'<b>轉移升級<span style="font-size:66.6%">14</span></b><br>你在購買首12升級，才可以解鎖這個。這個升級，隨着更多的聲望力量，增加轉移點數獲得數。',
	supernova:'',snupg1:'<b>超新星升級<span style="font-size:66.6%">1</span></b><br>這個升級，隨着購買更多生產器，會增加全部生產器的生產力倍數。',snupg4:'<b>超新星升級<span style="font-size:66.6%">2</span></b><br>這個升級，隨着總共恆星，會增加全部生產器的生產力倍數。',snupg5:'<b>超新星升級<span style="font-size:66.6%">3</span></b><br>這個升級，會增加全部生產器的生產力倍數，然後在超新星後慢慢減少。',snupg6:'<b>超新星升級<span style="font-size:66.6%">4</span></b><br>這個升級，隨着超新星的次數，增加聲望力量獲得數。',
	snupg7:'<b>超新星升級<span style="font-size:66.6%">5</span></b><br>這個升級，隨着中子星的數量，增加轉移點數獲得數。',snupg8:'<b>超新星升級<span style="font-size:66.6%">6</span></b><br>這個升級將聲望力量獲得數三倍。',snupg9:'<b>超新星升級<span style="font-size:66.6%">7</span></b><br>這個升級將每購買1第十級生產器的加成到1.13倍。',snupg10:'<b>超新星升級<span style="font-size:66.6%">8</span></b><br>這個升級，隨着更多轉移升級，會增加全部生產器的生產力倍數。',
	snupg11:'<b>超新星升級<span style="font-size:66.6%">9</span></b><br>這個升級，隨着更多聲望力量，減少生產器的成本。',snupg12:'<b>超新星升級<span style="font-size:66.6%">10</span></b><br>這個升會增加全部生產器的生產力倍數。',snupg13:'<b>超新星升級<span style="font-size:66.6%">11</span></b><br>這個升級，隨着在超新星前更短的最後一次轉移時間，會增加全部生產器的生產力倍數。',snupg14:'<b>超新星升級<span style="font-size:66.6%">12</span></b><br>這個升級將全部生產器的生產力倍數增加10倍。',
	snupg15:'<b>超新星升級<span style="font-size:66.6%">13</span></b><br>這個升級，隨着更多成就，會增加全部生產器的生產力倍數。',snupg16:'<b>超新星升級<span style="font-size:66.6%">14</span></b><br>這個升級，隨着更多第十級生產器，會增加第一級生產器的生產力倍數。',snupg2:'<b>超新星升級<span style="font-size:66.6%">15</span></b><br>這個升級將開始時已購買轉移升級。',snupg3:'<b>轉移升級<span style="font-size:66.6%">16</span></b><br>這個升級，隨着更多中子星，開始時會有更大聲望力量。',
	autoupgrader:'<b>自動升級</b><br>這個自動購買，會自動將轉移升級跟次序購買。',autotransfer:'<b>自動轉移</b><br>這個自動購買，當轉移點數獲得數到達你的轉移點數的倍數，或者一個數量時，會自動轉移。',autoprestige:'<b>自動聲望</b><br>這個自動購買，當聲望力量獲得數到達你的聲望力量的倍數時，會自動聲望。',autogenerator:'<b>自動生產器</b><br>自動生產器會自動購買全部生產器。',autonova:'<b>自動超新星</b><br>這個自動購買，當中子星到達一個數量時，會自動超新星。',
	bisfeature1:'<b>購購商店特徵<span style="font-size:66.6%">1</span></b><br>這個自動購買特徵將自動生產器在每一個間隔裏，每一級購買幾個。',bisfeature2:'<b>購購商店特徵<span style="font-size:66.6%">2</span></b><br>這個自動購買特徵允許自動生產器的購買次序。',bisfeature3:'<b>購購商店特徵<span style="font-size:66.6%">3</span></b><br>這個自動購買特徵允許改變自動聲望倍數(當聲望力量獲得數到達你的聲望力量的倍數時自動聲望)',bisfeature4:'<b>購購商店特徵<span style="font-size:66.6%">4</span></b><br>這個自動購買特徵允許改變自動轉移倍數(當轉移點數獲得數到達你的轉移點數的倍數時自動轉移)',bisfeature5:'<b>購購商店特徵<span style="font-size:66.6%">5</span></b><br>這個自動購買特徵解鎖不同的自動轉移，就是當轉移點數獲得數到達一個數量。',bisfeature6:'<b>購購商店特徵<span style="font-size:66.6%">6</span></b><br>這個自動購買特徵解鎖自動超新星，就是一個來臨的自動購買。',
	nbPowers:'<b>中子加成</b><br>中子加成有些有限的升級，增加全部生產器，除了最後一個，的生產力倍數。首三個升級以底數增加生產力倍數，在冪前；而你可以以恆星，轉移點數或者中子星花費 。<br>你可以購買其中一個升級，高達20次(如果是使用中子星購買，就是30次)，就是這些升級的最大等級。<br>中子加成除外，你還可以破裂限制，獲得更多恆星！好哇！ ',nbBase:'<b>中子加成<span style="font-size:66.6%">底數升級</span></b><br>這個升級增加底數，在冪前的值，給予更強的中子加成。你可以升級這個升級，高達10次，就是這個升級的最大。',nbPPPower:'<b>中子加成<span style="font-size:66.6%">聲望力量</span></b><br>這個升級從中子加成增加聲望力量獲得數，以一個亞線性率計算(x<sup>n</sup>而n<1)。你可以升級這個升級，高達5次，就是這個升級的最大。',
	neutronTiers:'<b>中子階級</b><br>普通生產器除外，還有另一組生產器，叫做中子階級。反而，這組的第一級生產器生產中子，減少其餘的生產器的成本；而且購買一個，會將生產力倍數增強5倍！',snupg17:'<b>超新星升級<span style="font-size:66.6%">17</span></b><br>這個升級將第一級中子生產器的生產力倍數增加成10倍，而不是5倍。',snupg18:'<b>超新星升級<span style="font-size:66.6%">18</span></b><br>這個升級，隨着更多中子，會增甲第二級中子生產器的生產力倍數。',snupg19:'<b>超新星升級<span style="font-size:66.6%">19</span></b><br>這個升級，隨着購買更多第八級中子生產器，增加第三級中子生產器的生產力倍數。',snupg20:'<b>超新星升級<span style="font-size:66.6%">20</span></b><br>這個升級，隨着更多聲望力量，增加第四級中子生產器的生產力倍數。',snupg21:'<b>超新星升級<span style="font-size:66.6%">21</span></b><br>這個升級，隨着……增加第五級中子生產器的生產力倍數。',
	snupg22:'<b>超新星升級<span style="font-size:66.6%">22</span></b><br>這個升級，隨着……增加第六級中子生產器的生產力倍數。',snupg23:'<b>超新星升級<span style="font-size:66.6%">23</span></b><br>這個升級，隨着……增加第七級中子生產器的生產力倍數。',snupg24:'<b>超新星升級<span style="font-size:66.6%">24</span></b><br>這個升級，隨着……增加第八級中子生產器的生產力倍數。',snupg25:'<b>超新星升級<span style="font-size:66.6%">25</span></b><br>這個升級，隨着……增加第九級中子生產器的生產力倍數。',snupg26:'<b>超新星升級<span style="font-size:66.6%">26</span></b><br>這個升級，隨着……增加第十級中子生產器的生產力倍數。',
	growthRate:'<b>生長率</b><br>生長率的意思是，你會在一秒後獲得的資源的百分比。<br>例如, 12%的生長率的意思是你會在一秒後獲得那資源的12%。'}
tab='gen'
oldTab=tab
lastTab=tab
showTooMuch=false
...
function gameTick() {
	...
	if (tab=='supernova') {
		...
		if (SNTab=='autobuyers') {
			var currentText='間隔: '+formatTime(player.autobuyers.interval)+'<br>'
