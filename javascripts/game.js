...
explainList={stars:'<b>恆星</b><br>恆星是遊戲中的主要貨幣和貨幣部分。你可以以這個花費於生產器！',gens:'<b>生產器</b><br>生產器是遊戲中的生產部分。遊戲中有10級，一級會生產上一級，但第一級會生產恆星。<br>當你購買一個，那個生產器會有一個5%的加成。',prestige:'<b>聲望</b><br>聲望是一個<i>軟</i>重置，但你會保留一些特徵和內容。<br>在這個遊戲，如果你立即聲望，你會將生產器上有一個倍數加成。',transfer:'<b>Transfer</b><br>Transfer is like prestige, but it resets all of your prestiges and give the player upgrades instead of production multiplier. The currency when you transfer is called transfer points, where you can spend upgrades with it.',
